class DropBoxController {
    ...
    constructor(){
        ...
        this.onselchange = new Event ('selectionchange');
    ...
    initEvents(){
        ...
        this.listFilesEl.addEventListener('selectionchange', e =>{
            ...
            if(this.getSel().length===0){

                this.btnDelete.style.display='none';
                this.btnRename.style.display='none';

            }else if(this.getSel().length===1){
        ...
        this.inputFilesEl.addEventListener('change', event =>{
            ...
            this.uploadTasks(event.target.files).then(response =>{
        ...
        li.addEventListener('click', e =>{
            ...
            if(e.shiftKey){
                ...
                if(firstLi){
                    ...
                    this.listFilesEl.dispatchEvent(this.onselchange);
    ...
    //Configuração do Firebase e Ajax

    firebaseConfig(){

        var config = {
            apiKey: "AIzaSyC9v6N_On9VmaA6u7DonLW8i6-U-1N3BdQ",
            authDomain: "dropbox-clone-bb4be.firebaseapp.com",
            databaseURL: "https://dropbox-clone-bb4be-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-bb4be",
            storageBucket: "dropbox-clone-bb4be.appspot.com",
            messagingSenderId: "233721849074",
          };
    ...
    ajaxConfig(url, method = 'GET', formData = new FormData(), onprogress = function(){}, onloadstart = function(){}){
    ...
    //Funcionalidade de Upload e Exclusão
    ...
    uploadTasks(files){
        ...
        [...files].forEach(file=>{
            ...
            promises.push(this.ajaxConfig('/upload', 'POST', formData, ()=>{
    ...
    removeTask(){
        ...
        this.getSel().forEach(li=>{
            ...
            promises.push(this.ajaxConfig('/file', 'DELETE', formData));
