class DropBoxController {
    ...
    constructor() {
        ...
        this.btnSendFilesEl = document.getElementById('btn-send-file');
    ...
    formatTime(duration) {
        ...
        let sec = parseInt((duration / 100) % 60);
        let min = parseInt((duration / (100 * 60)) % 60);
